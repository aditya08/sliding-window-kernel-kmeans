...
2. Matrix implementation (computes full kernel matrix, all clusters update formulation): based on the Popcorn paper: [PPoPP25](https://dl.acm.org/doi/10.1145/3710848.3710887)
